...
// --> More than One Rollover
			...
			if (rolloverPart1.intValue == 3) {				
				...
				EditorGUILayout.LabelField (new GUIContent("Text:",
					...
					"\n" +
					"(ex:. " +
					missionText.GetArrayElementAtIndex(11).stringValue.ToString() + 
					" contained " +
					missionText.GetArrayElementAtIndex(11).stringValue.Length.ToString() + " letters." +
					"\n" +
					missionText.GetArrayElementAtIndex(11).stringValue.Length.ToString() + 
...
// Create Hole
	...
	private void Display_Other_Options (){
		...
		if (!b_Mission_Timer.boolValue)
		{
			...
			if (EditorGUI.EndChangeCheck())
			{
				b_Mission_Timer.boolValue = false;
			}
